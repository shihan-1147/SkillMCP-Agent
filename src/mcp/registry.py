...
class ToolRegistry:
    ...
    def register(
        self, name: str, implementation: "BaseTool", definition: Tool = None
    ) -> None:
        """
        注册工具
    ...
    def get_tools_for_llm(self) -> List[Dict[str, Any]]:
        ...
        """
        return [
            definition.to_openai_format() for definition in self._definitions.values()
        ]
    ...
    def get_tools_by_category(self, category: str) -> List[Tool]:
        ...
        """
        return [
            tool for tool in self._definitions.values() if tool.category == category
        ]
