...
class SystemTimeTool(BaseTool):
    ...
    def _parse_relative_date(self, expr: str) -> Dict[str, Any]:
        ...
        # 3. 检查"下周X"模式
            ...
            full_weekday = (
                "周" + weekday_part if len(weekday_part) == 1 else weekday_part
            )
        ...
        if target_date:
            ...
            return {"success": False, "error": f"无法解析日期表达式: {expr}"}
    ...
    def _format_timestamp(self, timestamp: int, fmt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "data": {"timestamp": timestamp, "format": fmt, "formatted": formatted},
            }
